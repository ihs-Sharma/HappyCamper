...
extension TabPageViewController {
    ...
    fileprivate func setupScrollView() {
        ...
        scrollView?.backgroundColor = UIColor.white //UIColor.init(patternImage: UIImage.init(named: "Group 12-1")!)
        //option.pageBackgoundColor
    ...
    fileprivate func updateNavigationBar() {
        if let navigationBar = navigationController?.navigationBar {
            ...
            navigationBar.setBackgroundImage(option.tabBackgroundImage, for: .compact)
